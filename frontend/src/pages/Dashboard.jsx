...
const DEFAULT_IMG = "https://i.pinimg.com/1200x/50/bb/19/50bb19ebe06049da09f065b743286426.jpg"; //default recipe img
        ...
        <nav className="flex justify-between items-center max-w-7xl mx-auto px-6 py-5">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => navigate('/profile')}
              className="bg-[#0f5238] text-white px-6 py-2.5 font-bold text-sm shadow-lg hover:bg-[#064e3b] transition-all flex items-center gap-2"
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{ maxWidth: 560 }}>
              <h1 style={{
                fontFamily: 'Lexend', fontSize: 42, fontWeight: 700, color: 'white',
              ...
              <button onClick={() => navigate('/meal-planner')}
                style={{
                  marginTop: 28, background: 'white', color: '#0f5238', padding: '12px 32px',
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{
                ...
                <span style={{
                  fontSize: 11, fontWeight: 700, letterSpacing: '.08em', opacity: .8,
          ...
          {[
            ...
            <div key={label} className="dash-card" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{
                  fontSize: 11, fontWeight: 700, color: '#707973',
        ...
        <section style={{ marginBottom: 56 }}>
              ...
              return (
                <div key={slot} className="dash-card" style={{
                  ...
                  <div style={{ padding: 20 }}>
                    <span style={{
                      fontSize: 11, fontWeight: 800, color: '#895100',
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 14 }}>
                      ...
                      {recipe?.cuisine && (
                        <span style={{
                          padding: '4px 12px', background: '#b1f0ce', color: '#0e5138',
          ...
          <div className="dash-card" style={{
            ...
            <div style={{ width: '100%', height: 10, background: '#edeeef', borderRadius: 9999, overflow: 'hidden' }}>
              <div style={{
                height: '100%', width: `${Math.round(calPct * 100)}%`,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, marginBottom: 56 }}
              ...
              {myRecipes.map(r => (
                <div key={r._id} className="dash-card" style={{
                  ...
                  <div style={{ flexGrow: 1, minWidth: 0 }}>
                    <h4 style={{
                      fontFamily: 'Lexend', fontSize: 15, fontWeight: 600, color: '#0f5238',
                  ...
                  <button onClick={(e) => { e.stopPropagation(); navigate(`/recipes/${r._id}`); }}
                    style={{
                      padding: '8px 16px', border: '1px solid #bfc9c1', color: '#0f5238',
          ...
          <section>
            ...
            <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: 28 }}>
              ...
              {activities.length > 1 && (
                <div style={{
                  position: 'absolute', left: 23, top: 16, bottom: 16, width: 1,
