  ...
  return (
    <div style={{ background: 'white', borderRadius: '16px', overflow: 'hidden',
      ...
      <div style={{ position: 'relative' }}>
        <img src={recipe.image || 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500&q=80'} alt={recipe.title || recipe.name}
            ...
            <aside className="pf-sidebar" style={{ width: '300px', flexShrink: 0 }}>
              <div style={{ background: 'white', borderRadius: '20px', padding: '32px',
                ...
                <div style={{ position: 'relative', marginBottom: '20px' }}>
                  ...
                  <button onClick={() => fileInputRef.current.click()} style={{ position: 'absolute', bottom: '2px', right: '2px',
                ...
                <div style={{ width: '100%', display: 'flex', flexDirection: 'column',
                  ...
                  {[
                    ['menu_book',      'Recipes Created',  stats.recipesCreated],
