      ...
      schemas: {
        ...
        Meal: {
          ...
          properties: {
            ...
            description: {
              type: "string",
              example: "Healthy grilled chicken breast",
            },
            ingredients: {
              type: "array",
              items: { type: "string" },
              example: ["chicken", "olive oil"],
            },
    ...
    paths: {
      ...
      "/recipes": {
        post: {
          ...
          responses: {
            201: {
              description: "Recipe created with nutrition calculated",
              content: {
                "application/json": {
                  schema: {
                    type: "object",
        ...
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              in: "query",
              schema: { type: "number" },
              description: "Filter by max calories per serving",
            },
          ],
          responses: {
            200: {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    recipeId: {
                      type: "string",
                      example: "664a1f2e8c1b2a3d4e5f6a7b",
                    },
                  },
                },
              },
